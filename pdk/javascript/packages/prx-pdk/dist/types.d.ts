...
export declare function resultOk(output: string): PluginResult;
/** Create a failure `PluginResult`. */
export declare function resultErr(error: string): PluginResult;
/** Create a "continue" `MiddlewareAction` with the given data. */
export declare function middlewareContinue(data: string): MiddlewareAction;
/** Create a "block" `MiddlewareAction` with the given reason. */
export declare function middlewareBlock(reason: string): MiddlewareAction;
