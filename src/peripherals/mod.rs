...
/// Handle `openprx peripheral` subcommands.
    ...
    match cmd {
        crate::PeripheralCommands::List => {
            ...
            if boards.is_empty() {
                ...
                println!();
                println!("Add one with: openprx peripheral add <board> <path>");
                println!("  Example: openprx peripheral add nucleo-f401re /dev/ttyACM0");
                println!();
