# AGENTS.md — PRX Agent Engineering Protocol
...
PRX is a Rust-first autonomous agent runtime optimized for:
...
- If identity-like naming is required in tests/examples, use PRX-native labels only (`PRXAgent`, `prx_user`, `prx_node`).
